@php
    $items = [
        [
            ...
            'description' =>
                "Our ceremony is exclusive to close family and friends, because we'll struggle with it in front of them, let alone 90 odd faces 🙈",
        ],
        [
            'title' => 'Ceremony',
        ...
        [
            ...
            'description' =>
                'The bar opens, and the unwashed masses arrive! We welcome dear friends (and the others) to celebrate with us. BBQ, Cocktails, DJ, and Redwell Beer 🍻!',
        ],
        [
            'title' => 'BBQ',
        ...
        [
            ...
            'description' =>
                "Those camping will gather around the log fires, cuppa of hot cocoa (or maybe a cheeky espresso martini). Those not whisked away like Cinderella (just don't forget your shoes)",
        ],
    ];
@endphp
